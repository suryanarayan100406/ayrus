...
export default function LoginPage() {
    ...
    const { login, loginWithGoogle, error, clearError, initAuth, user } = useAuthStore();
    ...
    return (
        <div className="min-h-screen bg-dark-900 flex items-center justify-center px-4">
            <div className="absolute inset-0">
                <div className="absolute inset-0 bg-gradient-to-b from-primary-900/20 to-dark-900" />
            </div>
